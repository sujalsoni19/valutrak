    ...
    <div className="p-8 flex justify-center pt-16">
      ...
      >
        <header className="text-center pb-4 border-b border-indigo-500/50">
          <h1 className="text-2xl sm:text-4xl font-extrabold text-indigo-700 tracking-tight ">
        ...
        <section className="space-y-2">
          <h2 className="text-xl sm:text-2xl font-semibold text-teal-600">Our Mission</h2>
        ...
        <section className="pt-4">
          <blockquote className="mt-2 p-4 italic text-center text-lg sm:text-2xl text-purple-700 border-t border-b border-indigo-400/50 bg-white/60 rounded-lg">
